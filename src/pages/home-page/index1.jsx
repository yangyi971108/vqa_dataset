          ...
          <div className="main-con">
            ...
            <div className="center-con" id="center-con" style={{ position: 'absolute', left: '20%', top: '320px', backgroundColor: 'white', width: '60%' }}>
              ...
              <div className="section" id="nav-2" >
                <h2 style={{ color: 'darkgrey', fontSize: '1.5rem', top: '3.5rem', left: 40, position: 'relative' }}>Paper</h2>
                <Row justify="center" align="center" style={{ position: 'relative', top: '4rem' }} >
                  <Col span={4}>
              ...
              <div className="section" id="nav-4" >
                ...
                <div className={classes.examples}>
                    ...
                    <h3 style={{fontSize:'1.25rem',position:'relative',left:'3.5%',width:'12rem',backgroundColor: 'rgba(220,220,220,0.7)',display:'center',display:'flex',justifyContent:'center',alignItems:'center',top:'4.5rem'}}>Object detection</h3>
                    ...
                    <Divider style={{ position: 'relative', top: '9rem' }} />
                    
                    <h3 style={{fontSize:'1.25rem',position:'relative',left:'3.5%',width:'10rem',backgroundColor: 'rgba(220,220,220,0.7)',display:'center',display:'flex',justifyContent:'center',alignItems:'center',top:'10.5rem'}}>VQA</h3>
                    <img src={vqaImg} className={classes.vqaImg} />
                    <div style={{position:'relative',top:'15rem',fontSize:'1.2rem',lineHeight: 2, textAlign: 'justify',width:'90%'}}>The CSDQA dataset contains the knowledge units and question-and-answer pairs corresponding to the diagrams, which are used to conduct research related to DQA. Questions include true and false questions and multiple choice questions.</div>
                    

                    <div style={{ width: '100%', height: '24rem' }}></div>
